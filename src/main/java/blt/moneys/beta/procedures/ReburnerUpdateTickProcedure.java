...
public class ReburnerUpdateTickProcedure {
	public static void execute(Map<String, Object> dependencies) {
		...
		if (new Object() {
		...
		}.getItemStack(world, new BlockPos((int) x, (int) y, (int) z), 2)).getItem() == MoneysModItems.MINECOIN_RIP && (new Object() {
			public ItemStack getItemStack(LevelAccessor world, BlockPos pos, int sltid) {
				AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
				BlockEntity _ent = world.getBlockEntity(pos);
				if (_ent != null) {
		...
		}.getItemStack(world, new BlockPos((int) x, (int) y, (int) z), 4)).getItem() == MoneysModItems.MINECOIN_RIP && (new Object() {
			public ItemStack getItemStack(LevelAccessor world, BlockPos pos, int sltid) {
				AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
				BlockEntity _ent = world.getBlockEntity(pos);
				if (_ent != null) {
			...
			}
			{
				...
				if (_ent != null) {
					final int _sltid = 6;
					final ItemStack _setstack = new ItemStack(MoneysModItems.MINECOIN_50);
