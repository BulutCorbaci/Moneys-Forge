package blt.moneys.beta.world.features.treedecorators;
...
public class MoneyBiomeFruitDecorator extends CocoaDecorator {
	public static final MoneyBiomeFruitDecorator INSTANCE = new MoneyBiomeFruitDecorator();
	public static com.mojang.serialization.Codec<MoneyBiomeFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("money_biome_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public MoneyBiomeFruitDecorator() {
		super(0.2f);
	}
