...
public class MoneyBiomeLeaveDecorator extends LeaveVineDecorator {
	public static final MoneyBiomeLeaveDecorator INSTANCE = new MoneyBiomeLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("money_biome_tree_leave_decorator");
